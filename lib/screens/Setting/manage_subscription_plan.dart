...
class ManageSubscription extends StatefulWidget {
  ...
  const ManageSubscription({Key? key, this.offering}) : super(key: key);
  @override
...
class _ManageSubscriptionState extends State<ManageSubscription> {
  ...
  var selectedProduct;
  PremiumPlanList? activePlanIndex;

  CustomerInfo? customerInfo;
  Future<void> getCustomerInfo() async {
    customerInfo = await Purchases.getCustomerInfo();

    List<String> dataList = customerInfo!.activeSubscriptions.first.split(":");
    activePlanIndex = premiumList.firstWhere((element) => element.productId == dataList.first);
    setState(() {});
  }
  ...
  void initState() {
    ...
    AnalyticsService().setCurrentScreen(screenName: "ManageSubscription");
        ...
        child: Column(
          ...
          children: [
                ...
                child: Row(
                  ...
                  children: [
                    customerInfo != null && customerInfo!.activeSubscriptions.isNotEmpty
                        ? Text(
                            "ChatPix Ai - ${activePlanIndex?.duration ?? ""}",
            ...
            Padding(
              ...
              child: Text(
                "Your remaining days from the current subscription will be converted and added to new plan.",
